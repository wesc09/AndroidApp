...
public class Person extends Resource implements Serializable {
    ...
    @Expose
    private List<PersonVariables> variables = new ArrayList<PersonVariables>();
     ...
     *     The variables
     */
    public List<PersonVariables> getVariables() {
        return variables;
    }
    public PersonVariables getVariable() {
     ...
     *     The variables
     */
    public void setVariables(List<PersonVariables> variables) {
